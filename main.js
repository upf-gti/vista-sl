...
const avatars = [
    ...
    { id: "Eva", src: `${PERFORMS.AVATARS_URL}ReadyEva/ReadyEva_v4.glb`, config: `${PERFORMS.AVATARS_URL}ReadyEva/ReadyEva_v3.json`, type: "object", metadata: { preview:`${PERFORMS.AVATARS_URL}ReadyEva/ReadyEva.png` } },
    { id: "Victor", src:`${PERFORMS.AVATARS_URL}Victor/Victor.glb`, config: `${PERFORMS.AVATARS_URL}Victor/Victor.json`, type: "object", metadata: { preview: `${PERFORMS.AVATARS_URL}Victor/Victor.png` } },
